...
const companyOverviewItems: CompanyOverviewItem[] = [
  ...
  },
  {
    id: "capability",
    title: "기술력",
    description: "화학, 반도체, 식품, 공장 산업 시설 등 다양한 현장 프로젝트를 진행합니다.",
...
export function HomePage() {
  ...
  return (
    <>
      <MainBanner />
      <section className="page-body home-news-showcase" style={{ paddingTop: "2.75rem" }}>
            ...
            <div className="home-news-stage__text">
              <article className="home-news-article">
                <div className="home-news-article__top">
                  ...
                  <p className="home-news-article__meta">
      ...
      <section className="page-body home-masterpiece" style={{ paddingTop: 0 }}>
        <div
